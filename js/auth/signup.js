let inputNom = document.getElementById("NomInput");
let inputPrenom = document.getElementById("PrenomInput");
...
function validateForm() {
    ...
    let prenomOk = validateRequired(inputPrenom);
    let mailOk = validateMail(inputMail);
    let passwordOk = validatePassword(inputPassword);
    let passwordConfirmOk = validateConfirmationPassword(inputPassword, inputValidationPassword);
